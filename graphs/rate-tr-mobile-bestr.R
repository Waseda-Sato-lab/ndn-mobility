...
#
# rate-tr-mobile-bestr.R is free software: you can redistribute it and/or modify
# it under the terms of the GNU Affero Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
# rate-tr-mobile-bestr.R is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of              
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the               
# GNU Affero Public License for more details.                                 
#                                                                             
# You should have received a copy of the GNU Affero Public License            
# along with rate-tr-mobile-bestr.R.  If not, see <http://www.gnu.org/licenses/>.
#                    
...
data.mobile1 = read.table ("/home/jelfn/git/ndn-mobility/results/NDNMobilityRandom-rate-trace-bestr-01-001-054.txt", header=T)
data.mobile2 = read.table ("/home/jelfn/git/ndn-mobility/results/NDNMobilityRandom-rate-trace-bestr-02-001-054.txt", header=T)
data.mobile3 = read.table ("/home/jelfn/git/ndn-mobility/results/NDNMobilityRandom-rate-trace-bestr-03-001-054.txt", header=T)
data.mobile4 = read.table ("/home/jelfn/git/ndn-mobility/results/NDNMobilityRandom-rate-trace-bestr-04-001-054.txt", header=T)
...
g.test = ggplot (satTime, aes(linetype=Type, colour=Variable, shape=Type)) +
  ...
  xlab("Time") +
  ylab("Rate [Kbits/s]") +
  ggtitle("Throughput throughout NDN best route fowarding simulation") +
