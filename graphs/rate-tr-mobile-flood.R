...
#
# rate-tr-mobile-flood.R is free software: you can redistribute it and/or modify
# it under the terms of the GNU Affero Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# rate-tr-mobile-flood.R is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of              
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the               
# GNU Affero Public License for more details.                                 
#                                                                             
# You should have received a copy of the GNU Affero Public License            
# along with rate-tr-mobile-flood.R.  If not, see <http://www.gnu.org/licenses/>.
#                    
...
g.test = ggplot (satTime, aes(linetype=Type, colour=Variable, shape=Type)) +
  ...
  xlab("Time") +
  ylab("Rate [Kbits/s]") +
  ggtitle("Throughput throughout NDN Flood forwarding simulation") +
